...
'''
AGREGAMOS LA ESTACIÓN CANDIDATA A LA LISTA
'''        
               
        estaciones_candidatas.append({'Nombre': estacion['name'], 'Distancia': distancia})

'''
ORDENAMOS LA LISTA DE ESTACIONES CANDIDATAS POR DISTANCIA
'''        
        
estaciones_candidatas = sorted(estaciones_candidatas, key=lambda x: x['Distancia'])

'''
ENCONTRAMOS LA ESTACIÓN MÁS CERCANA QUE CUMPLA CON LOS CRITERIOS
'''
